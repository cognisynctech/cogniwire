    ...
    <div id="about" className="min-h-screen w-screen">
      <div className="relative mb-8 mt-36 flex flex-col items-center gap-5">
        ...
        <div className="about-subtext text-white">
          <p className="text-gray-400">Pioneering EEG technology in cognitive science</p>
          <p className="text-gray-400">
            Developing innovative EEG solutions at the viable cost to enhance cognition 
            and advance neuroscience for psychologists and researchers.
          </p>
        </div>
