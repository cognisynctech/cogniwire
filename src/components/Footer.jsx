...
const socialLinks = [
  { href: "https://www.linkedin.com/company/cogniwire-tech", icon: <FaLinkedin size={24} />, label: "LinkedIn" },
  { href: "https://x.com/cogniwiretech", icon: <FaTwitter size={24} />, label: "Twitter" },
  ...
  return (
    <footer className="bg-black text-white">      
      ...
      <div className="container mx-auto px-4 py-8 flex flex-col items-center gap-8">
        {/* Join Team Button - Now redirects to Careers */}
        <Button
          title="Join Team"
