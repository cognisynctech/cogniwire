...
const JoinTeamForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (missingFields.length > 0) {
      ...
      // Submit to Supabase - format data for career_applications table
      const applicationData = {
        name: formData.name,
        email: formData.email,
        phone: formData.phone,
        position_title: formData.field || 'Join Team Application',
        resume: formData.showcase || null,
        answers: JSON.stringify({
          ...
          favoriteProject: formData.favoriteProject
        })
      };
