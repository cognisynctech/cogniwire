...
const navItems = ["Home", "Products", "Careers", "Docs", "About", "Contact"];
...
const NavBar = ({ onProductsClick }) => {
  ...
  const handleNavClick = (item) => {
    ...
    if (itemLower === 'products') {
      if (onProductsClick) {
        onProductsClick();
      }
      return;
    }
    if (itemLower === 'careers') {
      navigate('/careers');
      return;
    }
    if (itemLower === 'docs') {
    ...
    // For other items, if we're on a different page, go home first
    if (location.pathname !== '/') {
      navigate(`/#${itemLower}`);
    } else {
